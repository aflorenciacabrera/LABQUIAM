        ...
        <div class="col-12">
            <div class="table-responsive">
                <div class="d-flex justify-content-between align-items-center py-2">
                    <h1 class="font-weight-light">Tipos de muestras</h1>
                    <div>
                        <button
                            type="button"
                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach ($tipos_de_muestras as $item)
                        <tr>
                            <th
                                class="table-procedencia-nombre"
                                data-key="{{ $item->id }}"
                                scope="row"
                                >{{ $item->tipo_de_muestra }}</th>
                            {{-- <td
      ...
      <div class="modal-body">
          <div class="container">
              <div class="form-group row">
                  ...
                  <div class="col-12">
                      <label for="input-fecha-ingreso">Nombre del tipo de muestra (*)</label>
    ...
    $(document).ready(function () {
        ...
        $('#btnModalNuevaProcedencia').click(function (e) {
            ...
            $('#modalProcedencia').on('shown.bs.modal', function (e) {
                ...
                modal.find('.modal-title').text('Agregar tipo de muestra')
        ...
        $('.btnModalEliminarProcedencia').click(function (e) {
            ...
            $('#modalProcedencia').on('shown.bs.modal', function (e) {
                ...
                modal.find('.modal-title').text('Eliminar tipo de muestra')
        ...
        $('.btnModalActualizarProcedencia').click(function (e) {
            ...
            $('#modalProcedencia').on('shown.bs.modal', function (e) {
                ...
                modal.find('.modal-title').text('Actualizar tipo de muestra')
